 ...
 */
export interface FluentBitCustomFilterPluginOptions extends FluentBitFilterPluginCommonOptions {
  /**
...
export class FluentBitCustomFilterPlugin extends FluentBitFilterPlugin {
  ...
  /**
     ...
     */
  public constructor(options: FluentBitCustomFilterPluginOptions) {
    super(options.name);
  ...
  /**
      ...
      * added.
      */
  public addField(key: string, ...values: string[]): FluentBitCustomFilterPlugin {
