...
export class AdotCollector extends Resource {
  /**
   ...
   */
  public static readonly DEFAULT_NAMESPACE: string = 'fargate-container-insights';
   ...
   */
  public constructor(scope: Construct, id: string, props: AdotCollectorProps) {
