...
import { Choice, Condition, DefinitionBody, Map, Pass, StateMachine } from 'aws-cdk-lib/aws-stepfunctions';
...
export interface ManageEc2InstancesProps extends ResourceManagerProps {}
