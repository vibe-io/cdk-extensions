...
export interface StopEc2InstanceProps extends ResourceManagerBaseProps {}

export class StopEc2Instance extends Resource {
  public readonly logGroup?: ILogGroup;
  public readonly stateMachine: StateMachine;


  public constructor(scope: IConstruct, id: string, props: StopEc2InstanceProps = {}) {
    ...
    const statusController = new StatusController(this, 'status-controller', {
      readyCondition: Condition.stringEquals(stateRef, 'running'),
      statusGetter: {
      ...
      successCondition: Condition.or(
        Condition.stringEquals(stateRef, 'stopped'),
    ...
    this.stateMachine = new StateMachine(this, 'Resource', {
      ...
      logs: logging,
      stateMachineName: 'stop-ec2-instance',
