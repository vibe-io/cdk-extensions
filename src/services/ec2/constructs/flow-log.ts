...
export class FlowLogField {
     ...
     */
    public static ACCOUNT_ID: FlowLogField = new FlowLogField('account-id', FlowLogDataType.STRING);
     ...
     * or network ACLs.
     */
    public static ACTION: FlowLogField = new FlowLogField('action', FlowLogDataType.STRING);
     ...
     */
    public static AZ_ID: FlowLogField = new FlowLogField('az-id', FlowLogDataType.STRING);

    /**
     * The number of bytes transferred during the flow.
     */
    public static BYTES: FlowLogField = new FlowLogField('bytes', FlowLogDataType.INT_64);
     ...
     */
    public static DSTADDR: FlowLogField = new FlowLogField('dstaddr', FlowLogDataType.STRING);

    /**
     * The destination port of the traffic.
     */
    public static DSTPORT: FlowLogField = new FlowLogField('dstport', FlowLogDataType.INT_32);
     ...
     * interface.
     */
    public static END: FlowLogField = new FlowLogField('end', FlowLogDataType.INT_64);

    /**
     * The direction of the flow with respect to the interface where traffic 
     * is captured. The possible values are: ingress | egress.
     */
    public static FLOW_DIRECTION: FlowLogField = new FlowLogField('flow-direction', FlowLogDataType.STRING);
     ...
     */
    public static INSTANCE_ID: FlowLogField = new FlowLogField('instance-id', FlowLogDataType.STRING);

    /**
     * The ID of the network interface for which the traffic is recorded.
     */
    public static INTERFACE_ID: FlowLogField = new FlowLogField('interface-id', FlowLogDataType.STRING);
     ...
     * an internal error.
     */
    public static LOG_STATUS: FlowLogField = new FlowLogField('log-status', FlowLogDataType.STRING);

    /**
     * The number of packets transferred during the flow.
     */
    public static PACKETS: FlowLogField = new FlowLogField('packets', FlowLogDataType.INT_64);
     ...
     */
    public static PKT_DST_AWS_SERVICE: FlowLogField = new FlowLogField('pkt-dst-aws-service', FlowLogDataType.STRING);
     ...
     */
    public static PKT_DSTADDR: FlowLogField = new FlowLogField('pkt-dstaddr', FlowLogDataType.STRING);
     ...
     */
    public static PKT_SRC_AWS_SERVICE: FlowLogField = new FlowLogField('pkt-src-aws-service', FlowLogDataType.STRING);
     ...
     * [Flow Log Example NAT](https://docs.aws.amazon.com/vpc/latest/userguide/flow-logs-records-examples.html#flow-log-example-nat)
     */
    public static PKT_SRCADDR: FlowLogField = new FlowLogField('pkt-srcaddr', FlowLogDataType.STRING);
     ...
     */
    public static PROTOCOL: FlowLogField = new FlowLogField('protocol', FlowLogDataType.INT_32);

    /**
     * The Region that contains the network interface for which traffic is 
     * recorded.
     */
    public static REGION: FlowLogField = new FlowLogField('region', FlowLogDataType.STRING);
     ...
     */
    public static SRCADDR: FlowLogField = new FlowLogField('srcaddr', FlowLogDataType.STRING);
    
    /**
     * The source port of the traffic.
     */
    public static SRCPORT: FlowLogField = new FlowLogField('srcport', FlowLogDataType.INT_32);
     ...
     * interface.
     */
    public static START: FlowLogField = new FlowLogField('start', FlowLogDataType.INT_64);
     ...
     * record displays a '-' symbol for this field.
     */
    public static SUBLOCATION_ID: FlowLogField = new FlowLogField('sublocation-id', FlowLogDataType.STRING);
     ...
     */
    public static SUBLOCATION_TYPE: FlowLogField = new FlowLogField('sublocation-type', FlowLogDataType.STRING);

    /**
     * The ID of the subnet that contains the network interface for which the 
     * traffic is recorded.
     */
    public static SUBNET_ID: FlowLogField = new FlowLogField('subnet-id', FlowLogDataType.STRING);
     ...
     */
    public static TCP_FLAGS: FlowLogField = new FlowLogField('tcp-flags', FlowLogDataType.INT_32);
     ...
     */
    public static TRAFFIC_PATH: FlowLogField = new FlowLogField('traffic-path', FlowLogDataType.INT_32);
     ...
     */
    public static TYPE: FlowLogField = new FlowLogField('type', FlowLogDataType.STRING);
     ...
     */
    public static VERSION: FlowLogField = new FlowLogField('version', FlowLogDataType.INT_32);

    /**
     * The ID of the VPC that contains the network interface for which the 
     * traffic is recorded.
     */
    public static VPC_ID: FlowLogField = new FlowLogField('vpc-id', FlowLogDataType.STRING);
...
export class FlowLogFormat {
     ...
     * custom format.
     */
    public static V2: FlowLogFormat = new FlowLogFormat(
     ...
     */
    public static V3: FlowLogFormat = new FlowLogFormat(
     ...
     * Local Zones.
     */
    public static V4: FlowLogFormat = new FlowLogFormat(
     ...
     */
    public static V5: FlowLogFormat = new FlowLogFormat(
