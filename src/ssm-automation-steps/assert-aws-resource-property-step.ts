...
export interface AssertAwsResourcePropertyStepProps extends StepBaseProps {
...
export class AssertAwsResourcePropertyStep extends StepBase {
  ...
  public constructor(scope: IConstruct, id: string, props: AssertAwsResourcePropertyStepProps) {
    ...
    if (Token.isUnresolved(this.service) || Token.isUnresolved(this.api)) {
      throw new Error([
        "When an AssertAwsResourceProperty step has an 'service' or 'api'",
        ...
        produce: () => {
          if (this._iamResources.length > 0) {
            ...
            Annotations.of(this).addWarning([
              'AssertAwsResourceProperty step has an implicit global allow',
  ...
  public addIamResource(resource: string): AssertAwsResourcePropertyStep {
    this._iamResources.push(resource);
    return this;
  }

  public addDesiredValue(value: string): AssertAwsResourcePropertyStep {
